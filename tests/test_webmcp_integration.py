...
def test_webmcp_asset_uses_current_imperative_document_model_context_surface(dsn):
    ...
    assert 'src="/static/firebase-auth-client.js?v=20260901-google-signin"' in index.text
    assert 'type="module" src="/static/app.js?v=20260901-google-signin"' in index.text
